...
class Level extends Phaser.Scene {
	...
	editorCreate() {
		...
		// cell_2
		const cell_2 = this.add.ellipse(717, 833, 70, 70);
		cell_2.isFilled = true;

		// cell_3
		const cell_3 = this.add.ellipse(828, 833, 70, 70);
		cell_3.isFilled = true;

		// cell_4
		const cell_4 = this.add.ellipse(929, 833, 70, 70);
		cell_4.isFilled = true;

		// cell_5
		const cell_5 = this.add.ellipse(1030, 833, 70, 70);
		cell_5.isFilled = true;

		// cell_6
		const cell_6 = this.add.ellipse(1129, 833, 70, 70);
		cell_6.isFilled = true;

		// cell_7
		const cell_7 = this.add.ellipse(1231, 833, 70, 70);
		cell_7.isFilled = true;

		// cell_8
		const cell_8 = this.add.ellipse(1334, 833, 70, 70);
		cell_8.isFilled = true;

		// cell_9
		const cell_9 = this.add.ellipse(604, 723, 70, 70);
		cell_9.isFilled = true;

		// cell_10
		const cell_10 = this.add.ellipse(717, 723, 70, 70);
		cell_10.isFilled = true;

		// cell_11
		const cell_11 = this.add.ellipse(827, 723, 70, 70);
		cell_11.isFilled = true;

		// cell_12
		const cell_12 = this.add.ellipse(928, 723, 70, 70);
		cell_12.isFilled = true;

		// cell_13
		const cell_13 = this.add.ellipse(1030, 723, 70, 70);
		cell_13.isFilled = true;

		// cell_14
		const cell_14 = this.add.ellipse(1130, 723, 70, 70);
		cell_14.isFilled = true;

		// cell_15
		const cell_15 = this.add.ellipse(1230, 723, 70, 70);
		cell_15.isFilled = true;

		// cell_16
		const cell_16 = this.add.ellipse(1335, 723, 70, 70);
		cell_16.isFilled = true;

		// cell_17
		const cell_17 = this.add.ellipse(603, 614, 70, 70);
		cell_17.isFilled = true;

		// cell_18
		const cell_18 = this.add.ellipse(717.1530300535503, 614, 70, 70);
		cell_18.isFilled = true;

		// cell_19
		const cell_19 = this.add.ellipse(828.2526274214182, 614, 70, 70);
		cell_19.isFilled = true;

		// cell_20
		const cell_20 = this.add.ellipse(928, 614, 70, 70);
		cell_20.isFilled = true;

		// cell_21
		const cell_21 = this.add.ellipse(1031, 614, 70, 70);
		cell_21.isFilled = true;

		// cell_22
		const cell_22 = this.add.ellipse(1130, 614, 70, 70);
		cell_22.isFilled = true;

		// cell_23
		const cell_23 = this.add.ellipse(1230, 614, 70, 70);
		cell_23.isFilled = true;

		// cell_24
		const cell_24 = this.add.ellipse(1334.2659222450707, 614, 70, 70);
		cell_24.isFilled = true;

		// cell_25
		const cell_25 = this.add.ellipse(603, 506, 70, 70);
		cell_25.isFilled = true;

		// cell_26
		const cell_26 = this.add.ellipse(715.6757463743146, 506, 70, 70);
		cell_26.isFilled = true;

		// cell_27
		const cell_27 = this.add.ellipse(828, 506, 70, 70);
		cell_27.isFilled = true;

		// cell_28
		const cell_28 = this.add.ellipse(928, 506, 70, 70);
		cell_28.isFilled = true;

		// cell_29
		const cell_29 = this.add.ellipse(1030.7499940584848, 506, 70, 70);
		cell_29.isFilled = true;

		// cell_30
		const cell_30 = this.add.ellipse(1130, 506, 70, 70);
		cell_30.isFilled = true;

		// cell_31
		const cell_31 = this.add.ellipse(1230, 506, 70, 70);
		cell_31.isFilled = true;

		// cell_32
		const cell_32 = this.add.ellipse(1333.6037994216217, 506, 70, 70);
		cell_32.isFilled = true;

		// cell_33
		const cell_33 = this.add.ellipse(603, 394, 70, 70);
		cell_33.isFilled = true;

		// cell_34
		const cell_34 = this.add.ellipse(716, 394, 70, 70);
		cell_34.isFilled = true;

		// cell_35
		const cell_35 = this.add.ellipse(826, 394, 70, 70);
		cell_35.isFilled = true;

		// cell_36
		const cell_36 = this.add.ellipse(927.8851166703676, 394, 70, 70);
		cell_36.isFilled = true;

		// cell_37
		const cell_37 = this.add.ellipse(1030.497770780217, 394, 70, 70);
		cell_37.isFilled = true;

		// cell_38
		const cell_38 = this.add.ellipse(1130.453690169301, 394, 70, 70);
		cell_38.isFilled = true;

		// cell_39
		const cell_39 = this.add.ellipse(1231, 394, 70, 70);
		cell_39.isFilled = true;

		// cell_40
		const cell_40 = this.add.ellipse(1334, 394, 70, 70);
		cell_40.isFilled = true;

		// cell_41
		const cell_41 = this.add.ellipse(603, 277, 70, 70);
		cell_41.isFilled = true;

		// cell_42
		const cell_42 = this.add.ellipse(716, 277, 70, 70);
		cell_42.isFilled = true;

		// cell_43
		const cell_43 = this.add.ellipse(826, 277, 70, 70);
		cell_43.isFilled = true;

		// cell_44
		const cell_44 = this.add.ellipse(927, 277, 70, 70);
		cell_44.isFilled = true;

		// cell_45
		const cell_45 = this.add.ellipse(1031.2593721979433, 277, 70, 70);
		cell_45.isFilled = true;

		// cell_46
		const cell_46 = this.add.ellipse(1130.3154399145712, 277, 70, 70);
		cell_46.isFilled = true;

		// cell_47
		const cell_47 = this.add.ellipse(1231, 277, 70, 70);
	...
	createMatrix(){
		...
		for (let i = 0; i < 7; i++) {
			matrix[i] = [];
			for (let j = 0; j < 7; j++) {
				matrix[i][j] = 0; // Change value to 0
			}
		}
		this.resultMatrix = [];
